...
val courseInfo =
    Ui.const <xml>
      ...
      <h3>Key links: <a href="http://adam.chlipala.net/frap/">book and related source code</a>; <a href="https://github.com/achlipala/6887psets">GitHub repo with problem sets and lab code</a></h3>
